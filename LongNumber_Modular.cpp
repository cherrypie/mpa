...
{
	if(x == LongNumber(0) || x == LongNumber(1) || d == LongNumber(1)) return x;
	if(d == LongNumber(0)) return LongNumber(1);
	...
	pair<LongNumber, LongNumber> uv = LongNumber::extended_gcd(n, k);
